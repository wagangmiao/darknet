...
#ifdef _DEBUG
#define lib_of_cv(name) "opencv_"name"243d.lib"
#else
#define lib_of_cv(name) "opencv_"name"243.lib"
#endif

#pragma comment (lib, lib_of_cv("imgproc"))
#pragma comment (lib, lib_of_cv("core"))
#pragma comment (lib, lib_of_cv("features2d"))
#pragma comment (lib, lib_of_cv("highgui"))
#undef lib_of_cv
